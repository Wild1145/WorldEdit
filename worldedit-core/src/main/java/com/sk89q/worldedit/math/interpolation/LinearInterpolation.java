...
public class LinearInterpolation implements Interpolation {
    ...
    public Vector3d getPosition(double position) {
        ...
        final Vector3d position1 = nodes.get(index1).getPosition();
        final Vector3d position2 = nodes.get(index1 + 1).getPosition();
    ...
    */
    ...
    private double arcLengthRecursive(int index, double remainderA, double remainderB) {
        final Vector3d position1 = nodes.get(index).getPosition();
        final Vector3d position2 = nodes.get(index + 1).getPosition();
