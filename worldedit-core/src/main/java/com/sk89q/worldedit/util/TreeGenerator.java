...
public class TreeGenerator {
    ...
    public enum TreeType {
        ...
        RANDOM_REDWOOD("Random spruce tree", "randspruce", "randredwood", "randomredwood", "anyredwood") {
            @Override
            public boolean generate(EditSession editSession, BlockVector3d pos) throws MaxChangedBlocksException {
     ...
     */
    private static void makePineTree(EditSession editSession, BlockVector3d basePosition)
     ...
     */
    private static boolean setChanceBlockIfAir(EditSession session, BlockVector3d position, BlockStateHolder block, double probability)
            throws MaxChangedBlocksException {
