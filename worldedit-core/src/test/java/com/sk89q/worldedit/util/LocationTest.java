...
public class LocationTest {
    ...
    public void testGetX() throws Exception {
        World world = mock(World.class);
        Location location = new Location(world, new Vector3d(TEST_VALUE, 0, 0));
    ...
    public void testSetX() throws Exception {
        World world = mock(World.class);
        Location location1 = new Location(world, Vector3d.ZERO);
    ...
    public void testGetY() throws Exception {
        World world = mock(World.class);
        Location location = new Location(world, new Vector3d(0, TEST_VALUE, 0));
    ...
    public void testGetZ() throws Exception {
        World world = mock(World.class);
        Location location = new Location(world, new Vector3d(0, 0, TEST_VALUE));
