...
final class TileEntityUtils {
     ...
     */
    private static NBTTagCompound updateForSet(NBTTagCompound tag, BlockVector3d position) {
        checkNotNull(tag);
     ...
     */
    static void setTileEntity(World world, BlockVector3d position, Class<? extends TileEntity> clazz, @Nullable NBTTagCompound tag) {
        checkNotNull(world);
        checkNotNull(position);
        checkNotNull(clazz);
     ...
     */
    static void setTileEntity(World world, BlockVector3d position, @Nullable NBTTagCompound tag) {
        if (tag != null) {
            updateForSet(tag, position);
     ...
     */
    @Nullable
    static TileEntity constructTileEntity(World world, BlockVector3d position, Class<? extends TileEntity> clazz) {
